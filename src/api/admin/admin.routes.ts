...
import {
    ...
    getAdminUnreadCounts, createUser, grantSmmaAccess, updateSmmaAccess, resendWelcomeEmail
...
router.post('/users/:userId/resend-welcome', resendWelcomeEmail); // Resend welcome email
